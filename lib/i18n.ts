...
export const dict = {
  en: { 'nav.latest': 'Latest', 'nav.feed': 'Feed', 'nav.write': 'Write', 'nav.login': 'Log in', 'nav.logout': 'Log out',
        'post.award': 'Award VIZ', 'post.awardsLabel': 'awards', 'post.comments': 'Comments', 'post.follow': 'Follow', 'post.unfollow': 'Unfollow',
  ...
  ru: { 'nav.latest': 'Свежее', 'nav.feed': 'Лента', 'nav.write': 'Написать', 'nav.login': 'Войти', 'nav.logout': 'Выйти',
        'post.award': 'Наградить VIZ', 'post.awardsLabel': 'наград', 'post.comments': 'Комментарии', 'post.follow': 'Подписаться', 'post.unfollow': 'Отписаться',
