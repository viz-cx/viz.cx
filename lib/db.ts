...
export const sql = globalThis._sql ?? postgres(URL_, { transform: { column: { from: postgres.toCamel, to: postgres.fromCamel } }, max: 10 })
...
export const fedifySql = globalThis._fedifySql ?? postgres(URL_, { max: 4 })
if (process.env.NODE_ENV !== 'production') globalThis._fedifySql = fedifySql
